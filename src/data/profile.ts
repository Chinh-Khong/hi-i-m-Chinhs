...
export const profileData: ProfileData = {
  ...
  projectsCount: "6+ Major Platforms",
...
export const profileStats: StatItem[] = [
  {
    ...
    description: "Developing production web applications at TDT Asia",
    iconName: "Clock"
  },
  {
    value: "6+ Major",
    label: "Production Systems",
    description: "Fintech, Loan Management, Insurance & E-commerce",
    iconName: "Rocket"
  },
  {
    value: "React & Next.js",
    label: "Core Frontend Stack",
    description: "Enterprise UI, TypeScript, TailwindCSS & APIs",
    iconName: "Code2"
  },
  {
    value: "Fintech & Webflow",
    label: "Specialized Domains",
    description: "B2B financial platforms for Singapore & Japan markets",
    iconName: "Sparkles"
  }
];
